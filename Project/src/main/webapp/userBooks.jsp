    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                    ...
                    <div class="row justify-content-md-center">
                        ...
                        <div class="col-sm-3">
                            <div class="image-bookCover">
                                <label for="bookCover">
                                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Click over and choose your cover book!">
                                        <img id="imgBookCover" src="assets/img/book_placeholder.png" class="rounded mx-auto d-block" alt="..." width="125" height="188">
                                    </span>
                                </label>
                                <input id="bookCover" type="file" id="formFile">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success">Register new book</button>
            </div>
        </div>
    </div>
</div>
